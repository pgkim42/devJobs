    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/", "/api/v1/auth/**","/api/v1/company-profile-code", "/oauth2/**", "/companyprofile/**", "/jobcategory/**", "/companyprofile/read/", "/similarposting/**", "/jobposting/list", "/jobposting/read/**","/jobposting/{jobCode}/company-profile-code", "/uploadfile/**", "/kakao-map/**").permitAll()
