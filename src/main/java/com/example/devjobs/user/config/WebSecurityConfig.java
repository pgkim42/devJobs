    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/", "/api/v1/auth/**", "/oauth2/**", "/jobcategory/**", "/companyprofile/read/", "/similarposting/**", "/jobposting/list", "/jobposting/read/**").permitAll()
                        .requestMatchers("/api/v1/company/**", "/companyprofile/**", "/jobposting/register", "/jobposting/modify", "/jobposting/remove/**").hasRole("COMPANY")
